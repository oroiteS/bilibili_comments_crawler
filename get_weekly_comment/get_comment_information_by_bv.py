...
def get_video_information(phase, bv):
    # 得到 cookies
    ...
    coll = db['bilibili']
    data = {"phase": phase, "bv": bv}
    with sync_playwright() as playwright:
        browser = playwright.chromium.launch(headless=True)  # 设置 headless=False 以显示浏览器窗口
        ...
        def scroll_page():
            for _ in range(10):  # 大约下滑 10 次
                ...
                page.wait_for_timeout(500)  # 等待页面加载，500 毫秒
